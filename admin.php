...
<body>
	<nav class="nav">
		<div class="nav-area">
			...
			<div class="nav-menu">
				<a href="?page=postingan">POSTINGAN</a>
				<a href="?page=pengguna">PENGGUNA</a>
				<a href="?page=likes">LIKE</a>
			...
			<div class="nav-menu-dekstop">
				<!-- <a href="#">Sign Up</a> -->
				<a href="?page=profil"> Hallo Admin!  <?php echo $_SESSION['username']?> </a>
			</div>
		</div>
    </nav>
        <div class="badan">
            ...
            if (isset($_GET['page'])){
                ...
                switch ($page) {
                    case 'postingan':
                        include "page_admin/index.php";
                        break;
                    case 'pengguna':
                        include "page_admin/pengguna.php";
                        break;
                    case 'likes':
                        include "page_admin/manage_like.php";
                        break;
                    case 'profil': 
