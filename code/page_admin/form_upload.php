...
<div style="width:800px; height:auto; background-color:#ffffff; padding:auto; margin:20 auto; border-redius:20px; border: 1px solid #000000; padding-bottom:20px; border-radius:20px; ">
    ...
    <table border="0" align="center">
        ...
        <tr>
            ...
            <td style=" padding:10px;"><input type="text" name="judul" style="background-color:#c7a59b; height:30px; border-radius:10px; padding-left:20px; font-size:16px;"></td> 
        </tr>
        <tr>
            <td style=" padding:10px;">Deskripsi </td>
            <td style=" padding:10px;">: </td>
            <td style=" padding:10px;"><textarea name="deskripsi" style="background-color:#c7a59b; height:70px; border-radius:10px; padding-left:20px; font-size:16px; width:400px; height:150px;"></textarea></td>
        </tr>
        <tr>
